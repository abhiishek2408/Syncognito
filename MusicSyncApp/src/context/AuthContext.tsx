...
export type User = { _id?: string; name?: string; email?: string; anonSlug?: string; avatar?: string; profile_pic?: string; role?: string; profile_status?: string; isPremium?: boolean; premiumPlan?: string } | null;
