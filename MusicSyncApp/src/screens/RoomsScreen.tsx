...
const getStyles = (theme: any, accentColor: string) => StyleSheet.create({
  ...
  joinInput: { flex: 1, backgroundColor: theme.surface, color: theme.text, paddingHorizontal: 16, borderRadius: 14, fontSize: 14, letterSpacing: 1.5, borderWidth: 1, borderColor: theme.border },
  ...
  modalInput: { backgroundColor: theme.surface, color: theme.text, paddingHorizontal: 16, paddingVertical: 14, borderRadius: 12, fontSize: 16, borderWidth: 1, borderColor: theme.border, marginBottom: 16 },
